 ...
 * Extiende de AfipWebService y proporciona métodos específicos para consultar datos en el padrón A5.
 *
 * @see AfipWebService
 */
...
{
    /** {@inheritdoc} */
    protected ?string $nombreArchivoWSDL = 'ws_sr_padron_a5-production.wsdl';

    /** {@inheritdoc} */
    protected ?string $urlServicio = 'https://aws.afip.gov.ar/sr-padron/webservices/personaServiceA5';

    /** {@inheritdoc} */
    protected ?string $nombreArchivoWSDLPrueba = 'ws_sr_padron_a5.wsdl';

    /** {@inheritdoc} */
    protected ?string $urlServicioPrueba = 'https://awshomo.afip.gov.ar/sr-padron/webservices/personaServiceA5';
     ...
     * {@inheritdoc}
     *
     * @return string Nombre del servicio AFIP para autorización (ws_sr_padron_a5).
     */
