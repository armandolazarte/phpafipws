...
try {
     ...
     **/
    $tipoNota = 13; // 13 = Nota de Crédito C

    /**
     * Número de la ultima Nota de Crédito C
     **/
    $ultimoComprobante = $facturacionElectronica->getUltimoComprobante($puntoVenta, $tipoNota);
     ...
     **/
    $tipoFacturaAsociada = 11; // 11 = Factura C
    ...
    /**
     * Importe total de la Nota de Crédito (Nota de Crédito C no discrimina IVA)
     **/
    $importeTotalComprobante = 100;
    ...
    $datosComprobante = [
        ...
        'ImpTotal' => $importeTotalComprobante,
        'ImpTotConc' => 0, // Importe neto no gravado
        'ImpNeto' => $importeTotalComprobante, // Importe neto (igual a ImpTotal para Nota de Crédito C)
